#
# Program the Cora Z7-07S over JTAG with the bitstream build_project.tcl
# produced, and load its debug probes file so the ILA shows real signal
# names in Hardware Manager.
#
# Usage:
...
if {![file exists $bitstream]} {
  error "No bitstream at $bitstream -- run build_project.tcl first"
}
