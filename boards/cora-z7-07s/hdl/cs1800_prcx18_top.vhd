...
ENTITY cs1800_prcx18_top IS
  ...
  PORT (
    ...
    -- Full io_sel_reg (CD4076 latch at OUT 11) visibility, 2026-09-18.
    -- Bit 7 is the real CDP1854 Master Reset trigger (see cdp1854.vhd's
    -- reset port); bits 1/2 are RSEL / port select.
