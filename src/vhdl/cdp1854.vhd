...
ENTITY cdp1854 IS
  PORT (
    ...
    -- Clock enable, so this chip can be driven by a real free-running
    ...
    -- of logic is a clock no timing tool analyses -- in the Cora build
    -- this entity alone accounted for most of 43 untimed register pins.
    -- Defaults to '1', so an instantiation that still passes TPB as
    -- `clk` behaves exactly as before.
    ce       : IN  STD_LOGIC := '1';
